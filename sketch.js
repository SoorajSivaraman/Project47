...
let explosionSound, gameOverMusic, gamePlayMusic, thrillerBGM, thrillerBGM2, gameWinMusic, bonusSound;
var startSprite;
...
function preload()
{
  ...
  thrillerBGM = loadSound("SoundFiles/thrillerBGM.mp3");
  thrillerBGM2 = loadSound("SoundFiles/thrillerBGM2.mp3");
...
function setup()
{
  ...
  playIcon = createSprite(displayWidth/2 + 100, displayHeight - 230);
...
function gameStart()
{
  ...
  text("* You win if CHORU escapes from the police for " + winTime + " seconds and earns wealth.", displayWidth/11, 480);
  text("* Press the PLAY Button to help CHORU do a good deed.", displayWidth/11, 545);
